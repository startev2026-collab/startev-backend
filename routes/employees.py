...
def get_store_users():
    ...
    # Fetch those users
    result = db.table("users").select("*").in_("id", user_ids).order("created_at", desc=True).execute()
